...
class File extends \control\fields\File
{
    ...
    public static function generateScript(){
        ...
        <script type="text/javascript">
            (function($,editor){
                editor.generate_file_field = function(fieldKey,data,cel){
                    data = $.extend({
                        'title':'未命名',
                        'description':'',
                        'max':1,
                    ...
                    let html =  '<div data-field="'+fieldKey+'" data-type="file" class="form-editor-field fui-form-builder--col fui-form-builder--col-'+(12/cel)+' ui-draggable ui-draggable-handle" >' +
                        '<div class="fui-form-field forminator-field-type_name">'+
                                ...
                                html+='<div style="margin:10px 10px;"><button type="button" class="btn btn-primary">选择文件</button></div>';
                                html+='</div>';
                ...
                editor.get_file_config=function(fieldKey,data){
                    return {
                        'base':{
                            'title':'标准',
                            'options': {
