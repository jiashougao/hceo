...
class Search extends \control\fields\Search
{
    ...
    public static function generateScript(){
        ...
        <script type="text/javascript">
            (function($,editor){
                editor.generate_search_field = function(fieldKey,data,cel){
                    data = $.extend({
                        'title':'未命名',
                        'description':'',
                        'required':false,
                    ...
                    return '<div data-field="'+fieldKey+'" data-type="search" class="form-editor-field fui-form-builder--col fui-form-builder--col-'+(12/cel)+' ui-draggable ui-draggable-handle" >' +
                ...
                editor.get_search_config=function(fieldKey,data){
                    return {
                        'base':{
                            'title':'标准',
                            'options': {
