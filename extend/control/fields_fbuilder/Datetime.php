...
class Datetime extends \control\fields\Datetime
{
    ...
    public static function generateScript(){
        ...
        <script type="text/javascript">
            (function($,editor){
                editor.generate_datetime_field = function(fieldKey,data,cel){
                    data = $.extend({
                        'title':'未命名',
                        'description':'',
                        'readonly':false,
                    ...
                    return '<div data-field="'+fieldKey+'" data-type="datetime" class="form-editor-field fui-form-builder--col fui-form-builder--col-'+(12/cel)+' ui-draggable ui-draggable-handle" >' +
                ...
                editor.get_datetime_config=function(fieldKey,data){
                    return {
                        'base':{
                            'title':'标准',
                            'options': {
