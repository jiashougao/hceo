...
class Select extends \control\fields\Select
{
    /**
     * 对数据查询进行过滤
     *
    ...
    public static function generateScript(){
        ...
        <script type="text/javascript">
            (function($,editor){
                editor.generate_select_field = function(fieldKey,data,cel){
                    data = $.extend({
                        'title':'未命名',
                        'description':'',
                        'options':[],
                    ...
                    let html =  '<div data-field="'+fieldKey+'" data-type="select" class="form-editor-field fui-form-builder--col fui-form-builder--col-'+(12/cel)+' ui-draggable ui-draggable-handle" >' +
                ...
                editor.get_select_config=function(fieldKey,data){
                    return {
                        'base':{
                            'title':'标准',
                            'options': {
