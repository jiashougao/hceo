...
class Editor extends \control\fields\Editor
{
    /**
     * 对数据查询进行排序
    ...
    public static function generateScript(){
        ...
        <script type="text/javascript">
            (function($,editor){
                editor.generate_editor_field = function(fieldKey,data,cel){
                    data = $.extend({
                        'title':'未命名',
                        'description':'',
                        'required':false,
                    ...
                    return '<div data-field="'+fieldKey+'" data-type="editor" class="form-editor-field fui-form-builder--col fui-form-builder--col-'+(12/cel)+' ui-draggable ui-draggable-handle" >' +
                                '<div class="fui-form-field forminator-field-type_name">'+
                                    ...
                                    '<img src="https://server.messecloud.com/static/dist/img/common/editor.png" style="width:100%;"/>'+
                                    '<span class="sui-description">'+data.description+'</span>'+
                                '</div>'+
                            '</div>';
                };

                editor.get_editor_config=function(fieldKey,data){
                    return {
                        'base':{
                            'title':'标准',
                            'options': {
