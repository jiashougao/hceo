...
class Datetime extends Base
{
    ...
    public function preview($strip_tags = false,$values=null){
        ...
        return "<code>".date("Y-m-d H:i",strtotime($value))."</code>";
    }
