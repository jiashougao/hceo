...
class Password extends Base
{
    public $default = array (
        ...
        'class' => array(),
        'style' => array(),
        'secure'=>false,//true:不输出值,false:输出值
        'placeholder' => '',
        'type' => 'text',
        'default'=>null,'value'=>'',
    ...
    public function generateField($form_id) {
        ...
        ?>
        <input type="password" value="<?php echo !$this->data['secure']?esc_attr($this->getValue()):'';?>" class="form-control <?php echo esc_attr( join(' ',array_unique($this->data['class']))  ); ?>" name="<?php echo $field?>" id="<?php echo $field?>"  style="<?php echo $this->getCustomerStyleHtml(); ?>" placeholder="<?php echo esc_attr( $this->data['placeholder'] ); ?>" <?php echo  $this->data['disabled']?'disabled':''; ?> <?php echo  $this->data['readonly']?'readonly':''; ?>   <?php echo $this->getCustomAttributeHtml(  ); ?> />
