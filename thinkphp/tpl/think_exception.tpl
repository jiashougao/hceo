...
<body>
    ...
    <?php if(function_exists('request')&& request()->isMobile()){
        ?> <link rel="stylesheet" href="/static/common/css/common.css" type="text/css" />
            <div class="header errorHeader">
                <img src="/static/common/img/errorIcon.png">
            </div>
            <div class="errorTitle">错误</div>
            <p class="textCenter">系统内部出现了不可预测的异常！</p>
        <?php
    }else{
        ?>
        <link href="/api/min.html?g=mp.error.css" rel="stylesheet" type="text/css" />
   <div class="page-500-full-page">
    <div class="row">
        <div class="col-md-12 page-500">
            ...
            <div class="details">
                <h3>系统发生了错误</h3>
                <p style="color:red;"> 系统发生了不可预测的异常！<br/> </p>
                <p>
                    <a href="/admin/login.html" class="btn red btn-outline"> 返回 </a>
                    <br>
                </p>
            </div>
        </div>
